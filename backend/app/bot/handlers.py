...
async def legal_info_handler(message: Message):
    await message.answer(
        ...
        "Настоящим оператор уведомляет о правилах работы сервиса:\n\n"
        "1. <b>Политика конфиденциальности</b>: Соблюдается в соответствии с 152-ФЗ.\n"
        "2. <b>Пользовательское соглашение</b>: Использование бота означает принятие условий.\n"
        "3. <b>Согласие на обработку ПДн</b>: Получается в момент отправки контактов.\n\n"
        "<i>Для получения полных текстов документов обратитесь к администратору или посетите наш сайт.</i>\n\n"
        "🏢 <b>Реквизиты оператора:</b>\n"
        "[Здесь укажите название вашей организации, ИНН, ОГРН]",
        parse_mode="HTML"
    )
